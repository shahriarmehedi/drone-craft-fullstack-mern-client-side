...
const Product = (props) => {
    ...
    return (
        <div className="transform hover:-translate-y-2 to-hover hover:shadow-2xl bg-gray-800 text-center secondary-bg transition duration-300 rounded-box w-full mx-auto">
