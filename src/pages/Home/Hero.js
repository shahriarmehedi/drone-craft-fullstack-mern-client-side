        ...
        <div className="bg-gray-50">
            <section className="container mx-auto text-left px-10 py-10">
                <div className="flex items-center justify-between flex-col lg:flex-row">
                    <div>
                        <h1 className=" text-5xl md:text-6xl lg:text-7xl font-bold my-10 leading-tight md:leading-relaxed"> <span className="text-red-500">Collection</span> of Drones <br />you'll love to have!
                        </h1>
