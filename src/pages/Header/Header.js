    ...
    if (showmenu) {
        menu =
            <div className="fixed bg-gray-800 top-0 left-0 w-4/5 h-full transition duration-500 shadow z-50">
                ...
                <h1 className="pt-10">{user?.email ? <button className="px-6 py-3  bg-yellow-400 rounded text-gray-800 hover:bg-white transition duration-300" onClick={logOut}>Log Out</button> : <NavLink to="/signup"><button
                ...
                <ul className="flex justify-between mt-2 items-center">
                    ...
                    <div className="hidden md:flex">
                        <li className="mx-5 hover:text-green-400"><NavLink to="/home" activeStyle={{
                            fontWeight: "bold",
                            color: "#FF0062"
                        }}><button className="py-3 font-semibold hover:text-pink-600 transition duration-300">HOME</button></NavLink>
                        </li>

                        <li className="mx-5 hover:text-green-400"><NavLink to="/explore" activeStyle={{
                            fontWeight: "bold",
                            color: "#FF0062"
                        }}><button className="py-3 font-semibold hover:text-pink-600 transition duration-300">EXPLORE PRODUCTS</button></NavLink>
                        </li>
                        ...
                        {
                            user?.email && <li className="mx-5 hover:text-pink-600 transition duration-300"> <NavLink to="/dashboard" activeStyle={{
                                fontWeight: "bold",
                                color: "#FF0062"
                        ...
                        <li className="xl:mx-5 lg:px-7 md:px-7 hidden md:flex">
                            {user?.email ? <button className="px-6 py-3 custom-pink-lite rounded text-white hover:text-pink-600 hover:bg-white transition duration-300" onClick={logOut}>Log Out</button> : <NavLink to="/login"><button
                                className="px-6 py-3 custom-pink-lite rounded text-white hover:text-pink-600 hover:bg-white transition duration-300">LOGIN</button></NavLink>}
                        </li>
                    </div>
                </ul>
            </nav>
